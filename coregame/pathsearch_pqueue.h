...
{
  //
  // Class PQueue - Path specific priority queue (template was problematic)
  //
  class PQueue
  {
  private:
  ...
  public:
    ...
    // Remove
    //
    // Removes the specified element, which MUST exist
    //
