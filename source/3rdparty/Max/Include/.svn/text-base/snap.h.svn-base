...
#define SNAP_APPLY_CONSTRAINTS	(1<<8)  //This suppresses any display in the views
#define SNAP_PROJ_XAXIS			(1<<9)  //This suppresses any display in the views
#define SNAP_PROJ_YAXIS			(1<<10)  //This suppresses any display in the views
#define SNAP_PROJ_ZAXIS			(1<<11)  //This suppresses any display in the views
