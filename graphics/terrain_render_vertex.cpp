...
namespace Terrain
{
  void RenderShroudWaterVtl( Cluster & clus, S32 x0, S32 z0, Vertex * verts0, U32 clipFlags)
  {
...
//    vertmem[3].diffuse  = 0xff000000;
  ...
  //
  void RenderCellWaterV( Cluster & clus, S32 x0, S32 z0, Vertex * verts0, F32 * fogs, U32 vcount, U32 clipFlags)
  {
    ...
    Vertex * v = vertmem, * ve = vertmem + 25, * sv = verts0;
...
//          Bool bright = (overlay.blend & RS_TEX_MASK) == RS_TEX_DECAL ? TRUE : FALSE;
          ...
          Utils::Memcpy( vertmem1, vertmem, sizeof(Vertex) * 4);
...
*/
  ...
  // skip backface culling
  //
  void RenderClusterMirrorMaskV( Cluster &clus, S32 x0, S32 z0, S32 x1, S32 z1, F32 y, U32 clipFlags)
  {
    clus;
...
//        vertmem[i].diffuse.a  = waterColorMirror.a;
      ...
      Vid::DrawIndexedPrimitive( 
        PT_TRIANGLELIST,
        FVF_TLVERTEX,
        vertmem, 4, Vid::rectIndices, 6, RS_BLEND_MODULATE);
...
//        temp[i].diffuse.a  = waterColorMirror.a;
      ...
      if (icount)
      {
        ...
        Vid::DrawIndexedPrimitive( 
          PT_TRIANGLELIST,
          FVF_TLVERTEX,
          vertmem, vcount, indexmem, icount, RS_BLEND_MODULATE);
...
//        U32 offset = clusOffz * cellPerClus * heightField.cellPitch + clusOffx * cellPerClus;
        ...
        RenderClusterMirrorMaskV( clus, xs, zs, xend, zend, clus.waterHeight, clipFlags);
